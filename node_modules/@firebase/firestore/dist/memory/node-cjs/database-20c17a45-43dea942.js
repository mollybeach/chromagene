 ...
 * Do not call this constructor directly. Instead, use {@link getFirestore}.
 */
class Firestore$1 extends Firestore$2 {
    /** @hideconstructor */
    constructor(databaseIdOrApp, authProvider) {
...
function getDoc(reference) {
    ...
    const firestore = cast(reference.firestore, Firestore$1);
    const client = ensureFirestoreConfigured(firestore);
...
function onSnapshot(reference, ...args) {
    ...
    if (reference instanceof DocumentReference$1) {
        ...
        firestore = cast(query.firestore, Firestore$1);
...
//# sourceMappingURL=database-20c17a45-43dea942.js.map
