...
function Header() {
  return (
    <header className="header">
      ...
      <Link to="/"className="header__logo"alt="Health Logo">     <img className = 'header__dna' src={dnaImg} alt=""/> </Link>
          <div className='header__company'>  <img className ="header__rainbow"src={company} alt=''></img></div>
